    ...
    <Router>
      <div className="app">
        <Switch>
          ...
          <Route
            path="/example/experimental"
            component={ExperimentalAssessment}
          />
          ...
          <Route
            path="/daily-activity-schedule"
            component={DailyActivitySchedule}
          />
          <Route
            path="/anti-procrastination"
            component={AntiProcrastinationSheet}
          />
          <Route
            path="/dysfunctional-thoughts"
            component={DysfunctionalThoughts}
          />
          ...
          <Route
            path="/motivation-without-coercion"
            component={MotivationWithoutCoercion}
          />
          ...
          <Route path="/components" component={CommonContainer} />
        </Switch>
      </div>
    </Router>
  </Provider>,
