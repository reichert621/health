...
const LeftOption = ({ value, color, isActive, transform, handleSelect }: OptionProps) => {
  return (
    <g id={`box-${value}`}
...
const RightOption = ({ value, color, isActive, transform, handleSelect }: OptionProps) => {
  return (
    <g id={`box-${value}`}
      className='svg-option-box'
      onClick={() => handleSelect(value)}>
...
const InnerOption = ({ value, color, isActive, transform, handleSelect }: OptionProps) => {
  return (
    <g id={`box-${value}`}
      className='svg-option-box'
      onClick={() => handleSelect(value)}>
...
const ChecklistOptionsSvg = ({ selected, handleSelect }: SelectorProps) => {
  return (
